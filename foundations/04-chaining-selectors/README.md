...
### Self Check
- Did you properly chain class selectors for each rule? - Complete
- Does the `proportioned` image retain its original square proportions? - Complete
- Does the `distorted` image end up looking squished and, well, distorted? - Complete
