...
### Self Check
- Does each element have a unique class name? - Complete
- Did you use the grouping selector for styles that both elements share? - Complete
- Did you make separate rules for the styles unique to each element? - Complete
